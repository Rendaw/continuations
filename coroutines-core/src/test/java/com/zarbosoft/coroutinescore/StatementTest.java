...
public class StatementTest {
	...
	@Test
	public void testSimpleCall() throws SuspendExecution {
	...
	@Test
	public void testAssignment() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
			final int x = method1();
	...
	@Test
	public void testLHS() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
			method2().x = 4;
	...
	@Test
	public void testSequence() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
	...
	@Test
	public void testPreincrement() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			int x = 0;
			b.append("a");
	...
	@Test
	public void testPostincrement() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			int x = 0;
			b.append("a");
	...
	@Test
	public void testAccess() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
	...
	@Test
	public void testConstructor() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
	...
	public static boolean testBooleanMethod2(
			final StringBuilder b, final String s1, final String s2
	...
	@Test
	public void testBooleanNoShortCircuitFirst() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
	...
	@Test
	public void testBooleanNoShortCircuitSecond() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
	...
	@Test
	public void testBooleanShortCircuitFirst() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
			if (testBooleanMethod2(b, "b", "c") || testBooleanMethod1(b, "d")) {
	...
	@Test
	public void testBooleanShortCircuitSecond() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
			if (testBooleanMethod1(b, "b") || testBooleanMethod2(b, "c", "d")) {
	...
	@Test
	public void testThrow() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
	...
	@Test
	public void testReturn() throws SuspendExecution {
		final StringBuilder b = new StringBuilder();
		final Coroutine coroutine = new Coroutine(() -> {
			b.append("a");
